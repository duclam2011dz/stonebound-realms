...
export class VoxelRaycaster {
  ...
  raycast(camera, maxDistance, isBlockFilled) {
    ...
    let tMaxX = this.rayDirection.x !== 0 ? (nextBoundaryX - this.rayOrigin.x) * invDx : Number.POSITIVE_INFINITY;
    let tMaxY = this.rayDirection.y !== 0 ? (nextBoundaryY - this.rayOrigin.y) * invDy : Number.POSITIVE_INFINITY;
    let tMaxZ = this.rayDirection.z !== 0 ? (nextBoundaryZ - this.rayOrigin.z) * invDz : Number.POSITIVE_INFINITY;
